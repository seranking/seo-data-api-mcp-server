    ...
    registerTool(server: McpServer): void {
        server.registerTool(
            'getPageAuthorityHistory',
            {
                ...
                description:
                    'Returns information about the historical values of InLink Rank for a specific target page.',
                inputSchema: {
                    ...
                    granularity: z.enum(['by_day', 'by_week', 'by_month']).optional().default('by_day')
                        .describe('Granularity at which to return data.'),
                },
            },
            async (params) => {
                return this.makeGetRequest('/v1/backlinks/authority/page/history', params);
            },
        );
    }
}
