...
export class DomainAioDiscoverBrand extends BaseTool {
  registerTool(server: McpServer): void {
    server.registerTool(
      "domainAioDiscoverBrand",
      {
        title: "AIO Discover Brand",
        description: "Fetch AI Overviews brand names (v1/domain/aio/discover-brand)",
        inputSchema: {
      ...
      async (params) => this.makeGetRequest('/v1/domain/aio/discover-brand', params)
    );
  }
}
