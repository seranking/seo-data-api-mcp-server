    ...
    registerTool(server: McpServer): void {
        server.registerTool(
            'recheckAudit',
            {
                ...
                inputSchema: {
                    audit_id: z.union([z.number(), z.string()]).describe('Unique identifier of the audit to recheck.'),
                    type: z.enum(['standard', 'advanced']).describe('Type of the audit to recheck (Standard or Advanced).'),
                },
            },
            async (params) => {
