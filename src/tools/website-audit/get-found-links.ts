        ...
        server.registerTool(
            'getFoundLinks',
            {
                ...
                inputSchema: {
                    ...
                    page_type: z.enum(['internal', 'external', 'all']).optional().default('all').describe('Filters links by type.'),
                    ...
                    filter: z
                        .array(
                            z.object({
                                ...
                                type: z.enum(['and', 'or']).optional().describe('The logical operator to connect this condition to the previous one.'),
                            }),
                        )
                        .optional()
