...
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `addSerpTasks`                     | Adds one or more search queries to the queue for SERP analysis. Note that SERP tasks usually take 60 seconds to finish.                                                                                                                                                                                                                                            |
| `createAdvancedAudit`              | Launches an advanced website audit that renders JavaScript before analyzing the page. Suitable for Single-Page Applications (SPAs) or dynamic content.                                                                                                                                                                                                             |
| `createStandardAudit`              | Launches a standard website audit that crawls the HTML of a website. Suitable for most static and server-side rendered sites.                                                                                                                                                                                                                                      |
| `deleteAudit`                      | Permanently deletes a specified website audit report and all of its associated data.                                                                                                                                                                                                                                                                               |
| `exportBacklinksData`              | Retrieves large-scale backlinks asynchronously, returning a task ID to check status later.                                                                                                                                                                                                                                                                         |
| `exportKeywords`                   | Retrieves metrics for a bulk list of keywords.                                                                                                                                                                                                                                                                                                                     |
| `getAiOverview`                    | Retrieves a high-level overview of a domain's performance in AI search engines. Returns aggregated data if no engine is specified, or engine-specific data if an engine is provided.                                                                                                                                                                               |
| `getAiPromptsByBrand`              | Retrieves a list of prompts where the specified brand is mentioned in AI search results.                                                                                                                                                                                                                                                                           |
| `getAiPromptsByTarget`             | Retrieves a list of prompts (queries) that mention the specified target in AI search results.                                                                                                                                                                                                                                                                      |
| `getAllBacklinks`                  | Retrieves a comprehensive list of backlinks for the specified target, with extensive filtering and sorting options.                                                                                                                                                                                                                                                |
| `getAuditHistory`                  | Retrieves a historical snapshot of a specific audit run, providing the full context of that audit.                                                                                                                                                                                                                                                                 |
| `getAuditPagesByIssue`             | Retrieves a paginated list of all URLs affected by a specific issue within a given audit.                                                                                                                                                                                                                                                                          |
| `getAuditReport`                   | Retrieves the full, detailed report for a completed website audit. Includes health score, domain properties, and broken down checks.                                                                                                                                                                                                                               |
| `getAuditStatus`                   | Checks the real-time status of a specific website audit, whether it’s queued, currently processing, or already finished.                                                                                                                                                                                                                                           |
| `getBacklinksAnchors`              | Retrieves a list of anchor texts for backlinks pointing to the specified target, with sorting and limit options.                                                                                                                                                                                                                                                   |
| `getBacklinksAuthority`            | Fetch authority metrics for a target (domain, host or URL) (v1/backlinks/authority)                                                                                                                                                                                                                                                                                |
| `getBacklinksIndexedPages`         | Fetch site pages that have backlinks, with sorting and limit controls (v1/backlinks/indexed-pages)                                                                                                                                                                                                                                                                 |
| `getBacklinksRefDomains`           | Retrieves a list of referring domains pointing to the specified target, with options for sorting and limiting results.                                                                                                                                                                                                                                             |
| `getBacklinksSummary`              | Retrieves a summary of backlink metrics for one or multiple targets (domains, subdomains, or URLs).                                                                                                                                                                                                                                                                |
| `getCrawledPages`                  | Returns a paginated list of all URLs found during an audit, providing a complete sitemap as discovered by the crawler.                                                                                                                                                                                                                                             |
| `getCumulativeBacklinksHistory`    | Returns a number of live backlinks for every day within the specified date range for the specified target.                                                                                                                                                                                                                                                         |
| `getDistributionOfDomainAuthority` | Returns information about the distribution of Domain InLink Rank (Domain Authority) of all the domains that reference a specific target.                                                                                                                                                                                                                           |
| `getDomainAdsByDomain`             | Retrieves paid ads for a specific domain.                                                                                                                                                                                                                                                                                                                          |
| `getDomainAdsByKeyword`            | Retrieves paid ads for a specific keyword.                                                                                                                                                                                                                                                                                                                         |
| `getDomainAuthority`               | Returns information about the domain InLink Rank (Domain Authority) of the target page’s root domain.                                                                                                                                                                                                                                                              |
| `getDomainCompetitors`             | Retrieves a list of organic or paid competitors for a domain.                                                                                                                                                                                                                                                                                                      |
| `getDomainKeywords`                | Retrieves a list of keywords for which a domain ranks in organic or paid search.                                                                                                                                                                                                                                                                                   |
| `getDomainKeywordsComparison`      | Analyzes and compares the keyword rankings of two websites: `domain` and `compare`. It can find keywords they have in common (`diff=0`) or identify a 'keyword gap' (`diff=1`)—keywords for which the `domain` ranks, but the `compare` domain does not. To find keywords the `compare` domain has but `domain` misses, swap the values of `domain` and `compare`. |
| `getDomainOverviewDatabases`       | Fetch domain overview by database (v1/domain/overview/db)                                                                                                                                                                                                                                                                                                          |
| `getDomainOverviewHistory`         | Retrieves historical data for domain traffic and keyword rankings.                                                                                                                                                                                                                                                                                                 |
| `getDomainOverviewWorldwide`       | Retrieves an aggregated worldwide overview of domain metrics.                                                                                                                                                                                                                                                                                                      |
| `getFoundLinks`                    | Returns a paginated list of every hyperlink discovered across the entire site during the audit.                                                                                                                                                                                                                                                                    |
| `getIssuesByUrl`                   | Retrieves a detailed list of all issues (errors, warnings, and notices) that were found on a single, specific page within an audit.                                                                                                                                                                                                                                |
| `getKeywordQuestions`              | Retrieves a list of question-based keywords containing the seed keyword.                                                                                                                                                                                                                                                                                           |
| `getLongTailKeywords`              | Retrieves a list of long-tail variations for the seed keyword.                                                                                                                                                                                                                                                                                                     |
| `getNewLostRefDomainsCount`        | Returns the number of referring domains, at least one backlink from which was newly found or lost in the specified date range, broken down by day.                                                                                                                                                                                                                 |
| `getPageAuthority`                 | Returns information about the InLink Rank (Page Authority) for a target URL.                                                                                                                                                                                                                                                                                       |
| `getPageAuthorityHistory`          | Returns information about the historical values of InLink Rank for a specific target page.                                                                                                                                                                                                                                                                         |
| `getReferringIps`                  | Returns information about IPv4 addresses that belong to backlinks that point to a target.                                                                                                                                                                                                                                                                          |
| `getReferringIpsCount`             | Returns the number of unique IPs linking to a target.                                                                                                                                                                                                                                                                                                              |
| `getReferringSubnetsCount`         | Returns the number of unique subnets/C-blocks linking to a target.                                                                                                                                                                                                                                                                                                 |
| `getRelatedKeywords`               | Retrieves a list of keywords semantically related to the seed keyword.                                                                                                                                                                                                                                                                                             |
| `getSerpLocations`                 | Retrieves a list of available locations for SERP analysis.                                                                                                                                                                                                                                                                                                         |
| `getSerpTaskAdvancedResults`       | Retrieves the status or advanced results of a specific SERP task. Note that SERP tasks usually take 60 seconds to finish. If the task is still running, returns {"status": "processing"}. If complete, returns the full JSON results including "items".                                                                                                            |
| `getSerpTaskResults`               | Retrieves the status or standard results of a specific SERP task. Note that SERP tasks usually take 60 seconds to finish. If the task is still running, returns {"status": "processing"}. If complete, returns the full JSON results including "items". This endpoint provides results for the following SERP item types only: organic, ads, and featured_snippet. |
| `getSerpTasks`                     | Retrieves a list of all SERP tasks added to the queue in the last 24 hours.                                                                                                                                                                                                                                                                                        |
| `getSimilarKeywords`               | Retrieves a list of keywords similar to the seed keyword.                                                                                                                                                                                                                                                                                                          |
| `listAudits`                       | Retrieves a list of all website audits associated with your account, providing key details and statistics for each.                                                                                                                                                                                                                                                |
| `listNewLostReferringDomains`      | Returns a list of referring domains, at least one backlink from which was (newly) found or lost in the specified date range for the specified target.                                                                                                                                                                                                              |
| `recheckAudit`                     | Launches a new crawl of a previously completed audit, using the same settings.                                                                                                                                                                                                                                                                                     |
| `updateAuditTitle`                 | Changes the title of an existing website audit report.                                                                                                                                                                                                                                                                                                             |
