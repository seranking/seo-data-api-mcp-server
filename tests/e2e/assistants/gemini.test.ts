...
const runGemini = (args: string[]): Promise<string> => new Promise((resolve, reject) => {
        ...
        const flags = [
            '--allowed-tools', 'DATA_getDomainOverviewWorldwide', '--allowed-tools', 'domain-overview-worldwide',
            '--allowed-tools', 'DATA_getBacklinksSummary', '--allowed-tools', 'backlinks-summary',
            '--allowed-tools', 'DATA_createStandardAudit', '--allowed-tools', 'create-standard-audit',
            '--allowed-tools', 'DATA_getAiOverview', '--allowed-tools', 'ai-search-overview',
            '--allowed-tools', 'DATA_exportKeywords', '--allowed-tools', 'keywords-export',
            '--allowed-tools', 'DATA_listAudits', '--allowed-tools', 'list-audits',
            '--allowed-tools', 'PROJECT_listProjects', '--allowed-tools', 'list-projects',
            '--allowed-tools', 'PROJECT_getProjectSummary', '--allowed-tools', 'get-project-summary',
            '--allowed-tools', 'PROJECT_createProjectGroup', '--allowed-tools', 'create-project-group',
            '--allowed-tools', 'PROJECT_listProjectGroups', '--allowed-tools', 'list-project-groups',
            '--allowed-tools', 'PROJECT_createKeywordGroup', '--allowed-tools', 'create-keyword-group',
            '--allowed-tools', 'PROJECT_listKeywordGroups', '--allowed-tools', 'list-keyword-groups',
